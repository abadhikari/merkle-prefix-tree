...
class MerklePrefixTree:
    ...
    def rehash(self, leaf_node):
        ...
        for i in range(self.height - 1, -1, -1):
            ...
            empty_hash = self.empty_tree_hash_dict[i + 1]
    ...
    def validate_inclusion_proof(self,
        ...
        for i in range(len(inclusion_proof) - 1, -1, -1):
            ...
            calculated_hash = hash_hashes(left_hash,
                                          right_hash,
                                          self.hash_func)
        ...
        def recurse_tree(root,
            ...
            if not root:
                if level <= self.height:
                    empty_hash = str(self.empty_tree_hash_dict[level])
